...
free(void *ap)
{
 ...
 6c1:	a1 80 0d 00 00       	mov    0xd80,%eax
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	89 15 80 0d 00 00    	mov    %edx,0xd80
}
 708:	5e                   	pop    %esi
 709:	5f                   	pop    %edi
 70a:	5d                   	pop    %ebp
 ...
 739:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 73c:	89 15 80 0d 00 00    	mov    %edx,0xd80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 3d 80 0d 00 00    	mov    0xd80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a7:	73 4f                	jae    7f8 <malloc+0xa8>
    ...
    if(p == freep)
 7a9:	8b 3d 80 0d 00 00    	mov    0xd80,%edi
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	a1 80 0d 00 00       	mov    0xd80,%eax
 ...
 804:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 807:	a3 80 0d 00 00       	mov    %eax,0xd80
}
 ...
 81e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 80 0d 00 00 84 	movl   $0xd84,0xd80
 827:	0d 00 00 
    base.s.size = 0;
 82a:	bf 84 0d 00 00       	mov    $0xd84,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 84 0d 00 00 84 	movl   $0xd84,0xd84
 836:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 83b:	c7 05 88 0d 00 00 00 	movl   $0x0,0xd88
 842:	00 00 00 
    if(p->s.size >= nunits){
