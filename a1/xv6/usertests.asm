...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12b:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1bf:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1d6:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1ed:	ff 35 5c 5e 00 00    	pushl  0x5e5c
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	ff 35 5c 5e 00 00    	pushl  0x5e5c
     ...
     2a0:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "fork failed\n");
     ...
     2b7:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    exit();
     ...
     2ce:	ff 35 5c 5e 00 00    	pushl  0x5e5c
     ...
     2e5:	ff 35 5c 5e 00 00    	pushl  0x5e5c
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     30b:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     356:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  printf(stdout, "openiput test ok\n");
     ...
     39a:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "fork failed\n");
     ...
     3bc:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d3:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "unlink failed\n");
     ...
     3ea:	ff 35 5c 5e 00 00    	pushl  0x5e5c
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     47f:	ff 35 5c 5e 00 00    	pushl  0x5e5c
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 5c 5e 00 00    	pushl  0x5e5c
     ...
     5de:	ff 35 5c 5e 00 00    	pushl  0x5e5c
     ...
     5f7:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     60e:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "read failed\n");
     ...
     625:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "unlink small failed\n");
     ...
     63c:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     653:	ff 35 5c 5e 00 00    	pushl  0x5e5c
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 5c 5e 00 00    	pushl  0x5e5c
     ...
     793:	ff 35 5c 5e 00 00    	pushl  0x5e5c
     ...
     7aa:	ff 35 5c 5e 00 00    	pushl  0x5e5c
     ...
     7c3:	ff 35 5c 5e 00 00    	pushl  0x5e5c
     ...
     7de:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7f5:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     80c:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "unlink big failed\n");
     ...
     823:	ff 35 5c 5e 00 00    	pushl  0x5e5c
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 5c 5e 00 00    	pushl  0x5e5c
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8fb:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     98f:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9a6:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9bd:	ff 35 5c 5e 00 00    	pushl  0x5e5c
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 5c 5e 00 00    	pushl  0x5e5c
     9e1:	e8 7a 30 00 00       	call   3a60 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 60 5e 00 00       	push   $0x5e60
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d50:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fba:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    303e:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    3059:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    3073:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    3092:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    30a9:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    30c0:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    30d7:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    30ee:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    311d:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    3134:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    314b:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    3162:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    319f:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    322b:	ff 35 5c 5e 00 00    	pushl  0x5e5c
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 5c 5e 00 00    	pushl  0x5e5c
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    3293:	ff 35 5c 5e 00 00    	pushl  0x5e5c
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    3310:	c7 04 85 a0 a5 00 00 	movl   $0x5430,0xa5a0(,%eax,4)
    3317:	30 54 00 00 
    ...
    332a:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    args[MAXARG-1] = 0;
    ...
    3357:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    3387:	ff 35 5c 5e 00 00    	pushl  0x5e5c
    ...
    339e:	ff 35 5c 5e 00 00    	pushl  0x5e5c
...
00003660 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3660:	69 05 58 5e 00 00 0d 	imul   $0x19660d,0x5e58,%eax
    3667:	66 19 00 
    366a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    366f:	a3 58 5e 00 00       	mov    %eax,0x5e58
}
    3674:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3be4:	eb 1a                	jmp    3c00 <printf+0x1a0>
          s = "(null)";
    3be6:	bb 5e 55 00 00       	mov    $0x555e,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c31:	a1 20 a6 00 00       	mov    0xa620,%eax
{
  ...
  freep = p;
    ...
    3c71:	5b                   	pop    %ebx
  freep = p;
    3c72:	89 15 20 a6 00 00    	mov    %edx,0xa620
}
    3c78:	5e                   	pop    %esi
    3c79:	5f                   	pop    %edi
    3c7a:	5d                   	pop    %ebp
  ...
  freep = p;
    3cac:	89 15 20 a6 00 00    	mov    %edx,0xa620
    p->s.size += bp->s.size;
    3cb2:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    3cb5:	8b 43 f8             	mov    -0x8(%ebx),%eax
    3cb8:	89 02                	mov    %eax,(%edx)
}
    3cba:	5b                   	pop    %ebx
    3cbb:	5e                   	pop    %esi
    3cbc:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3ccc:	8b 3d 20 a6 00 00    	mov    0xa620,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3d19:	8b 3d 20 a6 00 00    	mov    0xa620,%edi
  ...
  return freep;
    3d47:	a1 20 a6 00 00       	mov    0xa620,%eax
    ...
    3d74:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    3d77:	a3 20 a6 00 00       	mov    %eax,0xa620
}
    ...
    base.s.ptr = freep = prevp = &base;
    3d90:	c7 05 20 a6 00 00 24 	movl   $0xa624,0xa620
    3d97:	a6 00 00 
    base.s.size = 0;
    3d9a:	bf 24 a6 00 00       	mov    $0xa624,%edi
    base.s.ptr = freep = prevp = &base;
    3d9f:	c7 05 24 a6 00 00 24 	movl   $0xa624,0xa624
    3da6:	a6 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3da9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    3dab:	c7 05 28 a6 00 00 00 	movl   $0x0,0xa628
    3db2:	00 00 00 
    if(p->s.size >= nunits){
