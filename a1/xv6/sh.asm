...
00000180 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     189:	68 15 14 00 00       	push   $0x1415
     18e:	6a 02                	push   $0x2
     190:	e8 7b 0e 00 00       	call   1010 <printf>
  exit();
...
000001a0 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     1b5:	68 7b 13 00 00       	push   $0x137b
...
000001c0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1d9:	ff 24 85 30 14 00 00 	jmp    *0x1430(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1f9:	68 87 13 00 00       	push   $0x1387
     1fe:	6a 02                	push   $0x2
     200:	e8 0b 0e 00 00       	call   1010 <printf>
    break;
    ...
    panic("runcmd");
     ...
     2bd:	68 80 13 00 00       	push   $0x1380
     2c2:	e8 b9 fe ff ff       	call   180 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2c7:	51                   	push   %ecx
     2c8:	ff 73 08             	pushl  0x8(%ebx)
     2cb:	68 97 13 00 00       	push   $0x1397
     2d0:	6a 02                	push   $0x2
     2d2:	e8 39 0d 00 00       	call   1010 <printf>
      exit();
     2d7:	e8 a7 0b 00 00       	call   e83 <exit>
      panic("pipe");
     2dc:	83 ec 0c             	sub    $0xc,%esp
     2df:	68 a7 13 00 00       	push   $0x13a7
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     357:	6a 54                	push   $0x54
     359:	e8 12 0f 00 00       	call   1270 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     387:	6a 18                	push   $0x18
     389:	e8 e2 0e 00 00       	call   1270 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     457:	6a 08                	push   $0x8
     459:	e8 12 0e 00 00       	call   1270 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     489:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ad:	50                   	push   %eax
     4ae:	68 68 1a 00 00       	push   $0x1a68
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4fd:	50                   	push   %eax
     4fe:	68 68 1a 00 00       	push   $0x1a68
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     53e:	50                   	push   %eax
     53f:	68 60 1a 00 00       	push   $0x1a60
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     560:	56                   	push   %esi
     561:	68 68 1a 00 00       	push   $0x1a68
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 68 1a 00 00       	push   $0x1a68
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     673:	68 c9 13 00 00       	push   $0x13c9
     678:	53                   	push   %ebx
     679:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     6d2:	e8 99 0b 00 00       	call   1270 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     731:	e8 3a 0b 00 00       	call   1270 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     78e:	68 ac 13 00 00       	push   $0x13ac
...
parseexec(char **ps, char *es)
  ...
  cmd = malloc(sizeof(*cmd));
     7ad:	6a 54                	push   $0x54
     7af:	e8 bc 0a 00 00       	call   1270 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     7fe:	68 e1 13 00 00       	push   $0x13e1
     803:	57                   	push   %edi
     804:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     848:	68 d3 13 00 00       	push   $0x13d3
  ...
  return ret;
     ...
     879:	68 cc 13 00 00       	push   $0x13cc
...
00000890 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     89f:	68 e6 13 00 00       	push   $0x13e6
     8a4:	56                   	push   %esi
     8a5:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     8c9:	68 04 14 00 00       	push   $0x1404
  cmd = parseline(ps, es);
...
00000920 <parsepipe>:
{
  ...
  if(peek(ps, es, "("))
     92f:	68 e6 13 00 00       	push   $0x13e6
     934:	57                   	push   %edi
     935:	56                   	push   %esi
  ...
  if(peek(ps, es, "|")){
     ...
     950:	68 06 14 00 00       	push   $0x1406
     955:	57                   	push   %edi
     956:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     9a5:	e8 c6 08 00 00       	call   1270 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
000009e0 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     a12:	e8 59 08 00 00       	call   1270 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     ...
     a3b:	68 08 14 00 00       	push   $0x1408
     a40:	57                   	push   %edi
     a41:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     a51:	68 e4 13 00 00       	push   $0x13e4
     a56:	57                   	push   %edi
     a57:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     a8d:	e8 de 07 00 00       	call   1270 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000ac0 <parseexec>:
{
  ...
  if(peek(ps, es, "("))
     ...
     ace:	68 e6 13 00 00       	push   $0x13e6
     ad3:	56                   	push   %esi
     ad4:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     b29:	ff 24 85 48 14 00 00 	jmp    *0x1448(,%eax,4)
     ...
     bc5:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     be3:	68 96 13 00 00       	push   $0x1396
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     c0e:	52                   	push   %edx
     c0f:	50                   	push   %eax
     c10:	68 0a 14 00 00       	push   $0x140a
     c15:	6a 02                	push   $0x2
     c17:	e8 f4 03 00 00       	call   1010 <printf>
    panic("syntax");
     c1c:	c7 04 24 cc 13 00 00 	movl   $0x13cc,(%esp)
     ...
     f6c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
     ...
     fde:	56                   	push   %esi
     fdf:	57                   	push   %edi
     fe0:	e8 be fe ff ff       	call   ea3 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1021:	0f 84 b8 00 00 00    	je     10df <printf+0xcf>
  ap = (uint*)(void*)&fmt + 1;
  ...
  ap = (uint*)(void*)&fmt + 1;
    ...
    1035:	eb 37                	jmp    106e <printf+0x5e>
  ...
  write(fd, &c, 1);
    ...
    1059:	e8 45 fe ff ff       	call   ea3 <write>
  ...
  write(fd, &c, 1);
    ...
    10b9:	e8 e5 fd ff ff       	call   ea3 <write>
        putc(fd, c);
      } else {
  ...
  write(fd, &c, 1);
    ...
    10cd:	e8 d1 fd ff ff       	call   ea3 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    1144:	e8 5a fd ff ff       	call   ea3 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    11bb:	57                   	push   %edi
    11bc:	53                   	push   %ebx
    11bd:	e8 e1 fc ff ff       	call   ea3 <write>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11e1:	a1 e4 1a 00 00       	mov    0x1ae4,%eax
{
  ...
  freep = p;
    ...
    1221:	5b                   	pop    %ebx
  freep = p;
    1222:	89 15 e4 1a 00 00    	mov    %edx,0x1ae4
}
    1228:	5e                   	pop    %esi
    1229:	5f                   	pop    %edi
    122a:	5d                   	pop    %ebp
  ...
  freep = p;
    125c:	89 15 e4 1a 00 00    	mov    %edx,0x1ae4
    p->s.size += bp->s.size;
    1262:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    1265:	8b 43 f8             	mov    -0x8(%ebx),%eax
    1268:	89 02                	mov    %eax,(%edx)
}
    126a:	5b                   	pop    %ebx
    126b:	5e                   	pop    %esi
    126c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    127c:	8b 3d e4 1a 00 00    	mov    0x1ae4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    12c9:	8b 3d e4 1a 00 00    	mov    0x1ae4,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12db:	e8 2b fc ff ff       	call   f0b <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    12f7:	a1 e4 1a 00 00       	mov    0x1ae4,%eax
    ...
    1324:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1327:	a3 e4 1a 00 00       	mov    %eax,0x1ae4
}
    ...
    base.s.ptr = freep = prevp = &base;
    1340:	c7 05 e4 1a 00 00 e8 	movl   $0x1ae8,0x1ae4
    1347:	1a 00 00 
    base.s.size = 0;
    134a:	bf e8 1a 00 00       	mov    $0x1ae8,%edi
    base.s.ptr = freep = prevp = &base;
    134f:	c7 05 e8 1a 00 00 e8 	movl   $0x1ae8,0x1ae8
    1356:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1359:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    135b:	c7 05 ec 1a 00 00 00 	movl   $0x0,0x1aec
    1362:	00 00 00 
    if(p->s.size >= nunits){
