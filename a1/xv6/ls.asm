 ...
 8f1:	a1 18 0e 00 00       	mov    0xe18,%eax
{
 ...
 931:	5b                   	pop    %ebx
  freep = p;
 932:	89 15 18 0e 00 00    	mov    %edx,0xe18
}
 938:	5e                   	pop    %esi
 939:	5f                   	pop    %edi
 93a:	5d                   	pop    %ebp
 ...
 969:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 96c:	89 15 18 0e 00 00    	mov    %edx,0xe18
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 a02:	e8 e9 fe ff ff       	call   8f0 <free>
  return freep;
 a07:	a1 18 0e 00 00       	mov    0xe18,%eax
 ...
 a34:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 a37:	a3 18 0e 00 00       	mov    %eax,0xe18
}
