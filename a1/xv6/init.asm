 ...
 6a1:	a1 40 0b 00 00       	mov    0xb40,%eax
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	89 15 40 0b 00 00    	mov    %edx,0xb40
}
 6e8:	5e                   	pop    %esi
 6e9:	5f                   	pop    %edi
 6ea:	5d                   	pop    %ebp
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 40 0b 00 00    	mov    %edx,0xb40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d 40 0b 00 00    	mov    0xb40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 787:	73 4f                	jae    7d8 <malloc+0xa8>
    ...
    if(p == freep)
 789:	8b 3d 40 0b 00 00    	mov    0xb40,%edi
 ...
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 44 0b 00 00       	mov    $0xb44,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 44 0b 00 00 44 	movl   $0xb44,0xb44
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 81b:	c7 05 48 0b 00 00 00 	movl   $0x0,0xb48
 822:	00 00 00 
    if(p->s.size >= nunits){
