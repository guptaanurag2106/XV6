...
free(void *ap)
{
 ...
 731:	a1 00 0e 00 00       	mov    0xe00,%eax
{
 ...
 771:	5b                   	pop    %ebx
  freep = p;
 772:	89 15 00 0e 00 00    	mov    %edx,0xe00
}
 778:	5e                   	pop    %esi
 779:	5f                   	pop    %edi
 77a:	5d                   	pop    %ebp
 ...
 7a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7ac:	89 15 00 0e 00 00    	mov    %edx,0xe00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7cc:	8b 3d 00 0e 00 00    	mov    0xe00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 817:	73 4f                	jae    868 <malloc+0xa8>
    ...
    if(p == freep)
 819:	8b 3d 00 0e 00 00    	mov    0xe00,%edi
 ...
 842:	e8 e9 fe ff ff       	call   730 <free>
  return freep;
 847:	a1 00 0e 00 00       	mov    0xe00,%eax
 ...
 874:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 877:	a3 00 0e 00 00       	mov    %eax,0xe00
}
 ...
 897:	0e 00 00 
    base.s.size = 0;
 89a:	bf 04 0e 00 00       	mov    $0xe04,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 8a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8ab:	c7 05 08 0e 00 00 00 	movl   $0x0,0xe08
 8b2:	00 00 00 
    if(p->s.size >= nunits){
