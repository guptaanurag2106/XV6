...
struct proc {
  ...
  uint  rtp_time;      // Ticks Value at which the Real Time process is first created and arrives in run_queue (The point at which its scheduling policy is set), helps calculate absoulte deadline
